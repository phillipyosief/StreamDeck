...
from StreamDeckPi.src.backend.client import *
import json
...
with open('StreamDeckPi/resources/buttons.json', 'r') as b:
    btns = json.load(b)
...
class Images:
    width, height, channels, data = load_image("StreamDeckPi/resources/image.png")
...
def button_init():
    with open('StreamDeckPi/resources/buttons.json', 'r') as bjson:
        one()
        #
        add_spacing()
        #
